...
public class SkipLadderConfig
{
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> skip_stairs;
    ...
    static {
        ...
        skip_stairs = BUILDER.comment("Should skip stairs. Default: true").define("skip stairs", true);
